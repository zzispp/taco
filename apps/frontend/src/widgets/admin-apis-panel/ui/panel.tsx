...
import type { ApiPermission, ApiPermissionInput } from 'src/entities/api-permission';
...
import { useApis, translatedApiName, translatedApiGroup } from 'src/entities/api-permission';

import { createApi, deleteApi, updateApi } from 'src/features/api-permission-management/api';
