...
function useMenuResources() {
  ...
  return { t, filters, setFilters, menus, allMenus, expanded, setExpanded, head, treeRows, allIds, canAdd };
}
...
function useMenuDialogState() {
  ...
  return { form, setForm, editing, setEditing, creating, setCreating, submitting, setSubmitting, deleteTarget, setDeleteTarget, sortEdits, setSortEdits };
}
