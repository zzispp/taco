...
function createTypographyStyles(theme: Theme) {
  return {
...
function createImageStyles(theme: Theme) {
  return {
...
function createBlockquoteStyles(theme: Theme) {
  return {
    '& blockquote': {
      lineHeight: 1.5,
      fontSize: '1.5em',
...
function createCodeStyles(theme: Theme) {
  return {
    ...
    [`& .${markdownClasses.content.codeBlock}`]: {
      ...
      '& pre': {
        ...
        ...theme.applyStyles('dark', { backgroundColor: theme.vars.palette.grey[800] }),
      },
    },
  };
}
...
function createMarkdownStyles(theme: Theme) {
  return {
    ...
    ...createImageStyles(theme),
    ...createListStyles(),
    ...createBlockquoteStyles(theme),
    ...createCodeStyles(theme),
    ...createTableStyles(theme),
    ...createCheckboxStyles(theme),
  };
}

export const MarkdownRoot = styled('div')(({ theme }) => createMarkdownStyles(theme));
